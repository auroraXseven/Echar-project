        ...
        series: [
            {
                ...
                itemStyle: {
                    normal: {
                        // borderRadious  但需要在前面加上图表是什么类型的
                        barBorderRadius: 5,
                    }
                },
                barWidth: '35%',
        ...
        series: [
            {
                ...
                data: [30, 40, 50, 40, 30, 40,
                    30, 60, 20, 40, 50, 40, 30,
                    40, 30, 50, 30, 60, 20, 40,
                    30, 40, 30, 40, 30, 40, 20, 60, 50, 20]
            },
            {
                name: "播放量",
                type: 'line',
                ...
                data: [60, 10, 20, 40, 30, 40,
                    80, 60, 20, 40, 90, 40, 20,
                    60, 30, 40, 100, 20, 20, 40, 80, 70,
                    30, 40, 30, 90, 20, 99, 50, 20,]
            }
        ]
    };
    myChart.setOption(option)
...
//饼状图模块1
(function () {
    let myChart = echarts.init(document.querySelector(".pre .chart"))

    option = {
        color: ["#0663bc", "#0679bc", "#068fbc", "#06a5bc", "#06b0bc"],
        tooltip: {
            trigger: 'item',
...
//饼状图模块2 
(function () {
    let myChart = echarts.init(document.querySelector(".pre2 .chart"))
